...
void cubePrintRow(int a, int b, char c[9][6]){  //  Subroutine for cubePrint
    ...
    //  int 'w' for face
    int d;
    switch(a){                          //  Interprets 'x' call to start value of
        case 1:                         //  intended "row"
            d = 0;
            break;
        case 2:
...
void cubeTime(int a, int b, bool c){    //  Output total elapsed time, calculate a score based on time and turn count, print and update "hs.txt"
...
//
//  Might be interesting to decrease score as elapsed time goes up, as well as decrease score as move count goes up
//  I.E.:
